...
df_PCA_MCA_MFA<-subset(df, select = -c(Department,EducationField))
save(df_PCA_MCA_MFA, file = "dataframe_PCA_MCA_MFA.Rdata")
df_MLModels<-df
save(df_MLModels, file = "dataframe_MLModels.Rdata")
