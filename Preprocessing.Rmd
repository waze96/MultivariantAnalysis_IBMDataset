...
# Preprocesed Dataset
write.table(df, file = "./Data/preprocessed_IBM_Employees.csv", sep = ",", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)


# Dataset For PCA
df_PCA<-subset(df, select = -c(Department,EducationField))
df_PCA<-df_PCA[!sapply(df_PCA, is.factor)]
write.table(df_PCA, file = "./Data/preprocessed_PCA_IBM_Employees.csv", sep = ",", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)

# Dataset For MCA
df_MCA<-subset(df, select = -c(Department,EducationField))
df_MCA<-df_MCA[!sapply(df_MCA, is.factor)]
write.table(df_MCA, file = "./Data/preprocessed_MCA_IBM_Employees.csv", sep = ",", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)
